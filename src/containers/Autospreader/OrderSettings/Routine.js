...
class Routine extends React.Component {
    ...
    onSaveButtonClick() {
        ...
        let payup_percentage = this.state.payup_percentage
        let ratio_w_percentage = this.state.ratio_w_percentage
        let ratio_h_percentage = this.state.ratio_h_percentage
        obj = {
            'routine_id': routine_id, 'price': price, 'type': type, 'work_ex': work_ex,
            'work_ex_ac': work_ex_ac, 'quantity': quantity, 'payup_percentage':payup_percentage,
            'ratio_w_percentage':ratio_w_percentage, 'ratio_h_percentage':ratio_h_percentage
        };
    ...
    render() {
        ...
        let obje = {
            'price': price, 'type': type, 'work_ex': work_ex,
                                    ...
                                    <Modal.Body>
                                        <ContentHolder>
                                            <InputGroup compact style={{ marginBottom: '15px' }} >
                                                ...
                                                <br />
                                                <Col style={{ display: 'flex', direction: 'row' }} >
                                                    <Col span="8"><b> Payup %</b></Col>
                                                    <Input defaultValue="" type="text" value={this.state.payup_percentage}
                                                        onChange={e => this.updateInput("payup_percentage", e.target.value)} />
                                                </Col>
                                                <br />
                                                <Col style={{ display: 'flex', direction: 'row' }} >
                                                    <Col span="8"><b> Ratio Work %</b></Col>
                                                    <Input defaultValue="" type="text" value={this.state.ratio_w_percentage}
                                                        onChange={e => this.updateInput("ratio_w_percentage", e.target.value)} />
                                                </Col>
                                                <br />
                                                
                                                <Col style={{ display: 'flex', direction: 'row' }} >
                                                    <Col span="8"><b> Ratio Hedge %</b></Col>
                                                    <Input defaultValue="" type="text" value={this.state.ratio_h_percentage}
                                                        onChange={e => this.updateInput("ratio_h_percentage", e.target.value)} />
                                                </Col>
                                                <br />
                                                <Col style={{ display: 'flex', direction: 'row' }} >
