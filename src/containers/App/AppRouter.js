...
const routes = [
  ...
  {
    path: "orders",
    component: asyncComponent(() => import("../Autospreader/OrderDetails/TabComponents/OrdersTab"))
  },
  {
    path: "routines",
    component: asyncComponent(() => import("../Autospreader/OrderDetails/TabComponents/RoutinesTab"))
  },
